...
function countVowels(a) {
    return (a.match(/[aeiouAEIOU]/g) || []).length;
}
...
function firstAndLast(x) {
    var firstItem = first(x);
    var lastItem = last(x);
    var firstLastArray = [firstItem, lastItem];
...
function mean(addArray) {
    return sumAll(addArray) / addArray.length
}
...
function median(addArray) {
    addArray.sort ((a,b) => a - b);
    var half = Math.floor(addArray.length / 2)
    if (addArray.length % 2){
        return addArray[half]
    }else{
        return (addArray[half - 1] + addArray[half]) / 2.0;
    }
}
...
function maxMinusMin(addArray){
    var min = Math.min(...addArray);
    var max = Math.max(...addArray);
    return max - min;
}
...
function productOfAll(addArray) {
    return addArray.reduce ((a, b) => a * b);
}
...
function getHighestNumber(addArray) {
...
function getSmallestNumber(addArray) {
    return Math.min(...addArray);
}
...
function onlyOddNumbers(addArray) {
    var odds = addArray.filter(n => n%2);
    return odds
}
...
function onlyEvenNumbers(addArray) {
    return addArray.filter(function(val){return val%2===0})
}
...
function onlyPositiveNumbers(addArray) {
    return addArray.filter( (num) => num > 0 && num % parseInt(num) === 0 );
}
...
function onlyNegativeNumbers(addArray) {
    return addArray.filter( (num) => num < 0 && num % parseInt(num) === 0 );
}
...
function hasEvens(arr) {
    var evenNum = arr.filter((element) => element % 2 === 0);
    return evenNum.length > 0;
};
...
function countOdds(arr) {
    var oddNum = arr.filter((element) => element % 2 !== 0);
...
function countNegatives(arr){
    var negativeNumbers = arr.filter(n => n <0);
...
function countPositives(arr){
    var positiveNumbers = arr.filter(n => n > 0);
...
function onlyPositiveEvens(addArray){
    return onlyEvenNumbers(onlyPositiveNumbers(addArray));
}
...
function onlyPositiveOdds(addArray){
    return onlyOddNumbers(onlyPositiveNumbers(addArray));
}
...
function onlyNegativeEvens(arr){
    return onlyEvenNumbers(onlyNegativeNumbers(arr))
}
...
function onlyNegativeOdds(arr){
    return onlyOddNumbers(onlyNegativeNumbers(arr));
}
