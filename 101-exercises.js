...
function startsAndEndsWithVowel(string){
    var vowel1 = string[0];
    var vowel2 = string[string.length - 1];
    var v1 = false;
    var v2 = false;
    ...
    if (vowel1 == 'a' || vowel1 == 'A')
        ...
        v1 = false;
    if (vowel2 == 'a' || vowel2 == 'A')
        v2 = true;
    else if (vowel2 == 'e' || vowel2 == 'E')
        v2 = true;
    else if (vowel2 == 'i' || vowel2 == 'I')
        v2 = true;
    else if (vowel2 == 'o' || vowel2 == 'O')
        v2 = true;
    else if (vowel2 == 'u' || vowel2 == 'U')
        v2 = true;
    else
        v2 = false;
    if ( v1 == true && v2 == true){
...
var numbers = ["1","2","3","4"]
function firstToLast(numbers) {
    var moveToLast = numbers.shift();
    numbers.push(moveToLast);
    return numbers;
}
...
function findLargestNum(num) {
    ...
    var maxNumber = sorted[num.length - 1];
...
var words = ['hello', 'goodbye','hi', 'bye'];
function shortestString(numbers){
    return numbers.filter(e => typeof e === 'string').sort((a, b) => a.length - b.length)[0];
}
...
var numbers = ['1', '2', '3', '4'];
function addOneToArrray(numbers) {
    numbers = numbers.map(function(val){return ++val;});
    return numbers;
}
...
function totalNumberOfItems(shoppingCart) {
    ...
    for (var i = 0; i < shoppingCart.items.length; i++) {
        total = total + shoppingCart.items[i].quantity;
    }
    return total;
}
...
function getAverageItemPrice(x) {
    var numberOfItemTypes = x.items.length;
    var priceSum = 0;
    for (var i=0; i < x.items.length; i++) {
        priceSum = priceSum + x.items[i].price;
    }
...
function getAverageSpentPerItem(x) {
    ...
    var totalQty = 0;
    for (var i=0; i < x.items.length; i++) {
        console.log(x.items[i].price, x.items[i].quantity);
        totalSum = totalSum + (x.items[i].price * x.items[i].quantity);
        totalQty = totalQty + x.items[i].quantity;
    }
